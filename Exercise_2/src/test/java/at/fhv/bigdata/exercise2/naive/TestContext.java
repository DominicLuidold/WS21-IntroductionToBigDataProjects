...
public enum TestContext {
    ...
    private String mapInputFileName() {
        return "/average-temperature/temperature-input.txt";
    }

    private String reduceInputFileName() {
        return "/average-temperature/temperature-reducer-input.txt";
    }

    private String mapOutputFileName() {
        return "/average-temperature/temperature-mapper-output.txt";
    }

    private String reduceOutputFileName() {
        return "/average-temperature/temperature-reducer-output.txt";
    }
